...
class User extends Authenticatable
{
    ...
    public function docComments($doc_id)
    {
        return $this->hasMany(Comment::class, 'user_id')->where('document_id', $doc_id);
    }
    ...
    public function getOrdering($doc_id)
    {
        $ordering=$this->docUsers()->where('document_id', $doc_id)->first();
        return $ordering->pivot->ordering ?? '';
    }
