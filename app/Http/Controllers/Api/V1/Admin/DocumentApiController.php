...
class DocumentApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new DocumentResource(Document::with(['category', 'organisation', 'users', 'document_type'])->get());
    }
    ...
    public function show(Document $document)
    {
        ...
        return new DocumentResource($document->load(['category', 'organisation', 'users', 'document_type']));
    }
