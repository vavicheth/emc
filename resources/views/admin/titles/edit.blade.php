    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.titles.update", [$title->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $title->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_kh') ? 'is-invalid' : '' }}" type="text" name="name_kh" id="name_kh" value="{{ old('name_kh', $title->name_kh) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('abr') ? 'is-invalid' : '' }}" type="text" name="abr" id="abr" value="{{ old('abr', $title->abr) }}">
                @if($errors->has('abr'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('abr_kh') ? 'is-invalid' : '' }}" type="text" name="abr_kh" id="abr_kh" value="{{ old('abr_kh', $title->abr_kh) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $title->description) }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ $title->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
