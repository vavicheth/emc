    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.document-types.update", [$documentType->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value') ? 'is-invalid' : '' }}" type="text" name="value" id="value" value="{{ old('value', $documentType->value) }}" required>
                @if($errors->has('value'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $documentType->description) }}</textarea>
