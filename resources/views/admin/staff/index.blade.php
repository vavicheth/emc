                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            ...
                            @foreach(App\Models\Staff::GENDER_SELECT as $key => $item)
...
{ data: 'title_name', name: 'title.name' },
...
{ data: 'sigature', name: 'sigature', sortable: false, searchable: false },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Staff').DataTable(dtOverrideGlobals);
