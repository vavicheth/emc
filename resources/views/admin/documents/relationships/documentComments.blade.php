    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-documentComments">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($comments as $key => $comment)
                            <tr data-entry-id="{{ $comment->id }}">
                                ...
                                <td>
                                    <span style="display:none">{{ $comment->submit ?? '' }}</span>
                                ...
                                <td>
                                    <span style="display:none">{{ $comment->is_esign ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-documentComments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
